...
namespace FLC_Lab3.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewData["CourseID"] = new SelectList(_context.Courses, "CourseCodeID", "CourseName");
            ViewData["StudentID"] = new SelectList(_context.Students, "StudentNoID", "FirstName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,StudentID,CourseID")] Enrollment enrollment)
        {
            ...
            ViewData["CourseID"] = new SelectList(_context.Courses, "CourseCodeID", "CourseName", enrollment.CourseID);
            ViewData["StudentID"] = new SelectList(_context.Students, "StudentNoID", "FirstName", enrollment.StudentID);
            return View(enrollment);
        }
